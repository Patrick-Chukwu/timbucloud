...
const Product = ({ product, onClick }) => {
  return (
    <div className="flex flex-col gap-2 items-start justify-center bg-background shadow-lg rounded-[14px] xl:rounded-[20px] px-4 py-8  h-[428px] w-[335px] md:w-[312px] xl:w-[400px]" onClick={() => onClick(product)}>
