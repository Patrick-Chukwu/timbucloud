...
const Product = ({ product, onClick }) => {
  return (
    <div className=" flex flex-col gap-2 items-start justify-center bg-background shadow md:rounded-xl xl:rounded-3xl p-4 h-[428px] w-[335px] md:w-[312px] xl:w-[400px]" onClick={() => onClick(product)}>
